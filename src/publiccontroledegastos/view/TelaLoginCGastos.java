...
public class TelaLoginCGastos extends javax.swing.JFrame {

    public TelaLoginCGastos() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("INFORME O USUÁRIO E SENHA");
        ...
        txtUsuario.setText("franz");

        txtSenha.setFont(new java.awt.Font("Dialog", 0, 36)); // NOI18N
        ...
        lblStatus.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/com/controledegastos/icones/dberror.png"))); // NOI18N

        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/com/controledegastos/icones/money(2).png"))); // NOI18N
